...
#define CAFFE_WEITHTED_SOFTMAX_WITH_LOSS_LAYER_HPP_
...
class WeightedSoftmaxWithCrossEntropyLossLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
  explicit WeightedSoftmaxWithCrossEntropyLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "WeightedSoftmaxWithCrossEntropyLoss"; }
