#ifndef CAFFE_ORIENT_DETECTION_EVALUATE_LAYER_HPP_
#define CAFFE_ORIENT_DETECTION_EVALUATE_LAYER_HPP_
...
class OrientDetectionEvaluateLayer : public Layer<Dtype> {
 public:
  explicit OrientDetectionEvaluateLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "OrientDetectionEvaluate"; }
 ...
 protected:
   ...
   *   -# @f$ (1 \times 1 \times M \times 9) @f$
   *      M ground truth.
   *      [image_id, group_label, instance_id, xmin, ymin, xmax, ymax, diff, rotation]
...
#endif  // CAFFE_ORIENT_DETECTION_EVALUATE_LAYER_HPP_
