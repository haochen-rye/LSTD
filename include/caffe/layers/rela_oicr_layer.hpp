#ifndef CAFFE_Rela_OICR_LAYER_HPP_
#define CAFFE_Rela_OICR_LAYER_HPP_
...
//        BOTTOM[3]: SCORE (n \times num_proposal \times C)
//          * N is the number of proposals
//          * C is the number of classes
...
class RelaOICRLayer : public Layer<Dtype> {
 public:
  explicit RelaOICRLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "RelaOICR"; }
