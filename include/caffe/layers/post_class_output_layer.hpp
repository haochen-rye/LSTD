#ifndef CAFFE_POST_CLASS_OUTPUT_LAYER_HPP_
#define CAFFE_POST_CLASS_OUTPUT_LAYER_HPP_
...
class PostClassOutputLayer : public Layer<Dtype> {
 public:
  explicit PostClassOutputLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "PostClassOutput"; }
...
#endif  // CAFFE_POST_CLASS_OUTPUT_LAYER_HPP_
