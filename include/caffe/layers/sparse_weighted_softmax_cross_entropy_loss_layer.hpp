#ifndef CAFFE_SPARSE_WEIGHTED_SOFTMAX_WITH_LOSS_LAYER_HPP_
#define CAFFE_SPARSE_WEITHTED_SOFTMAX_WITH_LOSS_LAYER_HPP_
...
class SparseWeightedSoftmaxWithCrossEntropyLossLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
  explicit SparseWeightedSoftmaxWithCrossEntropyLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SparseWeightedSoftmaxWithCrossEntropyLoss"; }
